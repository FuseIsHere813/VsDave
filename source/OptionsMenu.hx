			...
			if (controls.ACCEPT)
			{
				...
				switch(curSelected)
				{
					...
					case 5:
						...
						var ctrl:Alphabet = new Alphabet(0, (70 * curSelected) + 30, (FlxG.save.data.donoteclick ? "Sound Feedback On" : "Sound Feedback Off"), true, false);
						ctrl.isMenuItem = true;
